...
func (_q *KeyQuery) QueryUser() *UserQuery {
...
func (_q *KeyQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *KeyQuery) FirstIDX(ctx context.Context) int {
...
func (_q *KeyQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *KeyQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *KeyQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *KeyQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *KeyQuery) WithUser(opts ...func(*UserQuery)) *KeyQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *KeyQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Key, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes,
			func(n *Key) { n.Edges.User = []*User{} },
			func(n *Key, e *User) { n.Edges.User = append(n.Edges.User, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *KeyQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Key, init func(*Key), assign func(*Key, *User)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(key.UserTable)
		s.Join(joinT).On(s.C(user.FieldID), joinT.C(key.UserPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(key.UserPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(key.UserPrimaryKey[1]))
